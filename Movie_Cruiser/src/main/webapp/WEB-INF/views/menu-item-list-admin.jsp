    ...
    Movie Cruiser</div>
       ...
       <div class="collapse navbar-collapse" id="collapsibleNavbar">  
            <ul class="navbar-nav active">
                <li class="nav-item">
                    <a class="nav-link" style="color: white;" href="admin"><i class="fas fa-tape" id="iconsize"></i> Movie List</a>
                </li>
                     ...
                     <div class="row">
                        ...
                        <div class="col-6 text-title">
                           <div class="float-right">
                            <div>
                               <i class="far fa-clock"></i> Launch </div>    
                            <div>  ${temp.dateOfLaunch} </div>
                            </div>
                            </div> 
                     </div>           
                     <div class="row">
                        <div class="col-12 addCart">
                           <a href="edit?id=${temp.id}">
