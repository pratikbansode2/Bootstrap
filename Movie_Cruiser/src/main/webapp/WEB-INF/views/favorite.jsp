...
<body>
    ...
    Movie Cruiser</div>
       ...
       <div class="collapse navbar-collapse" id="collapsibleNavbar">  
            <ul class="navbar-nav active">
                <li class="nav-item">
                    <a class="nav-link" style="color: white;" href="menu-item-list-customer"><i class="fas fa-tape" id="iconsize"></i> Movie List</a>
                </li>
    ...
    <div class="title1">Favorites <span class="badge badge-success">1</span></div>
